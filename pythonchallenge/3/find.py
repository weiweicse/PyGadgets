...
for i in range(0, len(lines)):
    for j in range(0, len(lines[i])):
        if lines[i][j].islower():
            if j < len(lines[i]) - 3 and j > 2:
                if lines[i][j+1].isupper() and lines[i][j+2].isupper() and lines[i][j+3].isupper() and lines[i][j-1].isupper() and lines[i][j-2].isupper() and lines[i][j-3].isupper():
                    if j > 3:
                        if lines[i][j-4].islower(): 
                            if j < len(lines[i]) - 4:
                                if lines[i][j+4].islower():
                                    res += lines[i][j]
                            else:
